...
-(void)menuInit
{
    QFMenuItem *menuItem = [[QFMenuItem alloc]initWithMenuId:1 andHotKey:@"1" andMenuName:@"学生上班打卡" andFuncName:@"" andParMenuId:0];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
    menuItem = [[QFMenuItem alloc]initWithMenuId:2 andHotKey:@"2" andMenuName:@"学生下班打卡" andFuncName:@"" andParMenuId:0];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
    ...
    menuItem = [[QFMenuItem alloc]initWithMenuId:6 andHotKey:@"6" andMenuName:@"上次晚自习下班时的照片" andFuncName:nil andParMenuId:0];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
    ...
    menuItem = [[QFMenuItem alloc]initWithMenuId:7 andHotKey:@"1" andMenuName:@"按照时间查询" andFuncName:@"" andParMenuId:3];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
    menuItem = [[QFMenuItem alloc]initWithMenuId:8 andHotKey:@"2" andMenuName:@"按照班级，姓名，时间查询" andFuncName:@"" andParMenuId:3];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
    
    menuItem = [[QFMenuItem alloc]initWithMenuId:9 andHotKey:@"1" andMenuName:@"以人为单位进行统计" andFuncName:@"" andParMenuId:4];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
    menuItem = [[QFMenuItem alloc]initWithMenuId:10 andHotKey:@"2" andMenuName:@"以班为单位进行统计" andFuncName:@"" andParMenuId:4];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
    
    menuItem = [[QFMenuItem alloc]initWithMenuId:11 andHotKey:@"1" andMenuName:@"录入" andFuncName:@"" andParMenuId:5];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
    menuItem = [[QFMenuItem alloc]initWithMenuId:12 andHotKey:@"2" andMenuName:@"查看" andFuncName:@"" andParMenuId:5];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
    
    menuItem = [[QFMenuItem alloc]initWithMenuId:13 andHotKey:@"1" andMenuName:@"录入" andFuncName:@"" andParMenuId:6];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
    menuItem = [[QFMenuItem alloc]initWithMenuId:14 andHotKey:@"2" andMenuName:@"查看" andFuncName:@"" andParMenuId:6];
    [self->_menuDict setObject:menuItem forKey:@(menuItem.menuId)];
}
